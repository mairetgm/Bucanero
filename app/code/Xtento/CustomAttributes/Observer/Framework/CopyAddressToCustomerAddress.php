 ...
 * Last Modified: 2019-06-14T13:42:17+00:00
 * File:          app/code/Xtento/CustomAttributes/Observer/Framework/CopyAddressToCustomerAddress.php
...
/**
 * Class CopyAddressToCustomerAddress
 * @package Xtento\Checkoutaddressfields\Observer\Framawork
 */
class CopyAddressToCustomerAddress implements ObserverInterface
{
    /**
     * @var LoggerInterface
     */
     ...
     * @event core_copy_fieldset_order_address_to_customer_address
     */
        ...
        if ($source instanceof Order\Address) {
            ...
            if ($extensionAttributes) {
                ...
                foreach ($customerAddressData as $key => $data) {
                    ...
                    $customAttributes = $this->customAttributesFactory->create();
                    $newCustomAttributes[$key] = $customAttributes->setAttributeCode($key)->setValue($data);
                }
                ...
                if (!empty($customAttributes)) {
                    $target->addData([CustomAttributesDataInterface::CUSTOM_ATTRIBUTES => $newCustomAttributes]);
                }
            }
        }
    }
