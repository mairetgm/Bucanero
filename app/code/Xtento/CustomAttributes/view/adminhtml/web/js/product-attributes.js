...
define([
    ...
    return function (optionConfig) {
        var swatchProductAttributes = {
                ...
                frontendOptionYesno: $('#frontend_option_yesno'),
                frontendOptionRadioYesno: $('#frontend_option_radio_yesno'),
                frontendOptionDateTimeYesno: $('#frontend_option_datetime_yesno'),
                frontendOptionMultipleCheckboxYesno: $('#frontend_option_multiplecheckbox_yesno'),
                maxLengthVisibility: $('#max_length'),
                showLastValueVisibility: $('#show_last_value'),
                defaultValueFrontendOptionText: $('#default_value_frontend_option_text'),
                isGlobal: $('#is_global'),
                ...
                switchDefaultValueField: function () {
                    var currentValue = this.frontendInput.val(),
                        ...
                        frontendOptionYesnoVisibility = false,
                        frontendOptionRadioYesnoVisibility = false,
                        frontendOptionDateTimeYesnoVisibility = false,
                        frontendOptionMultipleCheckboxYesNoVisibility = false,
                        maxLengthVisibility = true,
                        showLastValueVisibility = true,
                        defaultValueFrontendOptionTextVisibility = false,
                    ...
                    switch (currentValue) {
                        case 'select':
                            ...
                            frontendOptionRadioYesnoVisibility = true;
                            maxLengthVisibility = false;
                            break;

                        case 'multiselect':
                            optionDefaultInputType = 'checkbox';
                            frontendOptionMultipleCheckboxYesNoVisibility = true;
                            maxLengthVisibility = false;
                            break;

                        case 'date':
                            defaultValueDateVisibility = true;
                            frontendOptionDateTimeYesnoVisibility = true;
                            maxLengthVisibility = false;
                            break;
                        ...
                        case 'file':
                            maxLengthVisibility = false;
                            defaultValueTextareaVisibility = false;
                            showLastValueVisibility = false;
                            defaultValueFrontendOptionTextVisibility = false;
                            break;

                        case 'boolean':
                            defaultValueYesnoVisibility = true;
                            frontendOptionYesnoVisibility = true;
                            maxLengthVisibility = false;
                            break;
                        ...
                        default:
                            ...
                            defaultValueFrontendOptionTextVisibility = true;
                            break;
                    }
                            ...
                            switch (option) {
                                ...
                                default:
                                    if (typeof option == 'string') {
                                        //added by lucian if we will have hidden fields later
                    ...
                    this.setRowVisibility(this.frontendOptionYesno, frontendOptionYesnoVisibility);
                    this.setRowVisibility(this.frontendOptionRadioYesno, frontendOptionRadioYesnoVisibility);
                    this.setRowVisibility(this.frontendOptionDateTimeYesno, frontendOptionDateTimeYesnoVisibility);
                    this.setRowVisibility(this.frontendOptionMultipleCheckboxYesno, frontendOptionMultipleCheckboxYesNoVisibility);
                    this.setRowVisibility(this.maxLengthVisibility, maxLengthVisibility);
                    this.setRowVisibility(this.showLastValueVisibility, showLastValueVisibility);
                    this.setRowVisibility(this.defaultValueFrontendOptionText, defaultValueFrontendOptionTextVisibility);
