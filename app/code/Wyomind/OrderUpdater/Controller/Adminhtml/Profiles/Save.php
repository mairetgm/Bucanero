 ...
 */
class Save extends \Wyomind\OrderUpdater\Controller\Adminhtml\Profiles
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            if (!$this->_validatePostData($data)) {
                return $this->resultRedirectFactory->create()->setPath($this->module . '/profiles/edit', ['id'=>$model->getId(), "_current"=>true]);
            }
            ...
            try {
                ...
                if ($this->getRequest()->getParam('run_i')) {
                    ...
                    return $this->resultForwardFactory->create()->forward("run");
                }
