...
class Activate extends \Wyomind\Framework\Console\Command\LicenseAbstract
{
    ...
    public function configure()
    {
        $this->setName('wyomind:license:activate')
            ...
            ->setDefinition([
                new InputArgument(
                    "module", InputArgument::REQUIRED, __('The module for which you want to activate the license (eg: Wyomind_Framework)')
                ),
                new InputArgument(
                ...
                new Inputoption(
                    "auto-request", "r", Inputoption::VALUE_NONE, __('Automatically send a license request')
                )
            ]);
        parent::configure();
    }
