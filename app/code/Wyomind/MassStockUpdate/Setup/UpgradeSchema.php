...
class UpgradeSchema implements UpgradeSchemaInterface
{
                            ...
                            ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '9.7.0') < 0) {
            ...
            $setup->getConnection()->addColumn(
                $tableName, 'relative_stock_update', ['type' => \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER, 'length' => 1, 'nullable' => false, "default" => 0, "comment" => 'Enable the relative stock update']
            );
        ...
        if (version_compare($context->getVersion(), '9.8.0') < 0) {
            ...
            $setup->getConnection()->addColumn(
                $tableName, 'enabled', ['type' => \Magento\Framework\DB\Ddl\Table::TYPE_BOOLEAN, 'length' => 1, 'nullable' => false, "default" => 0, "comment" => 'Enable the profile']
            );
