...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('profile_method', $visibility, array('name' => 'profile_method', 'value' => $model->getProfileMethod(), 'label' => __('Profile method'), 'options' => array($class::UPDATE => __('Update existing products only'), $class::IMPORT => __('Import new products only'), $class::UPDATEIMPORT => __('Update products and import new products')), "note" => "<script> 
        ...
        /* XML */
        $fieldset->addField('xml_xpath_to_product', 'text', ['name' => 'xml_xpath_to_product', 'class' => 'updateOnChange', 'label' => __('Xpath to products'), 'required' => true, 'note' => __("xPath where the product data is stored in the XML file, e.g.:/catalog/products/product")]);
