...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('file_system_type', array('header' => __('File location'), 'align' => 'left', 'index' => 'file_system_type', 'type' => 'options', 'options' => array($classHelper::LOCATION_MAGENTO => __('Magento file system'), $classHelper::LOCATION_FTP => __('Ftp server'), $classHelper::LOCATION_URL => __('Url'), $classHelper::LOCATION_WEBSERVICE => __('Web service'), $classHelper::LOCATION_DROPBOX => __('Dropbox'))));
