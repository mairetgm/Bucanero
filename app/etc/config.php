...
return [
    'modules' => [
        ...
        'Wyomind_MsiBackorders' => 1,
        'Wyomind_MsiCustomAttributes' => 1,
        'Wyomind_MsiOrderManagement' => 1,
        'Wyomind_MsiPermissions' => 1,
        'Wyomind_MsiStockManagement' => 1,
        'Wyomind_MsiStockStatus' => 1,
        'Wyomind_OrderUpdater' => 1,
        'Wyomind_OrdersExportTool' => 1,
        'Wyomind_StoreLocator' => 1,
        'Xtento_XtCore' => 1,
        'Xtento_CustomOrderNumber' => 1,
        'Xtento_PdfCustomizer' => 1,
        'Xtento_CustomAttributes' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
